      ...
      <div style={{ display: 'flex', gap: '24px', flex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            border: '1.5px solid rgba(0, 223, 182, 0.3)',
            borderRadius: '16px',
            padding: '18px 8px',
            display: 'flex',
            flexDirection: 'column',
            ...
            {/* 告警 */}
            <button
              onClick={() => setActiveFilters(prev => ({ ...prev, alarm: !prev.alarm }))}
              style={{
                background: 'none',
                border: 'none',
            ...
            >
              ...
              <span style={{ fontSize: '11px', fontWeight: 'bold', letterSpacing: '0.5px' }}>告警</span>
            </button>

            {/* 微弱水平分割线 */}
            <div style={{ width: '28px', height: '1.5px', backgroundColor: 'rgba(255,255,255,0.06)' }} />

            {/* 通道 */}
            <button
              onClick={() => setActiveFilters(prev => ({ ...prev, channel: !prev.channel }))}
              style={{
                background: 'none',
                border: 'none',
            ...
            >
              ...
              <span style={{ fontSize: '11px', fontWeight: 'bold', letterSpacing: '0.5px' }}>通道</span>
            </button>
            ...
            {/* 标签 */}
            <button
              onClick={() => setActiveFilters(prev => ({ ...prev, label: !prev.label }))}
              style={{
                background: 'none',
                border: 'none',
            ...
            >
              ...
              <span style={{ fontSize: '11px', fontWeight: 'bold', letterSpacing: '0.5px' }}>标签</span>
            </button>
          </div>
